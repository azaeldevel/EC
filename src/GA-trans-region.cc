...
void Enviroment::creteRegion(std::list<nodes::Node*>& targets)
{
	...
	region->newEdgeFront(200,node_O,node_4);//ID:4
	...
	region->newEdgeFront(150,node_23,node_24);//ID:24
	...
	region->newEdgeFront(200,node_44,node_45);
	...
	//std::cout << node_O->getBack(0)->getNext()->getID() << "<--" << node_O->getBack(0)->getNode()->getID() << "\n";
